...
import com.dnk.spring.controller.EmpRestURIConstants;
import com.dnk.spring.model.Employee;
...
public class TestSpringRestExample {
	...
	private static void testGetEmployee() {
		RestTemplate restTemplate = new RestTemplate();
		Add emp = restTemplate.getForObject(SERVER_URI+"/rest/emp/1", Employee.class);
		printEmpData(emp);
	}
